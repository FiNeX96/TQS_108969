...
public class DefaultValues implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        ArrayList<Seat> seats_bus1 = new ArrayList<Seat>(bus1.getTotalSeats());
        ...
        ArrayList<Seat> seats_bus2 = new ArrayList<Seat>(bus2.getTotalSeats());
        ...
        ArrayList<Seat> seats_bus3 = new ArrayList<Seat>(bus3.getTotalSeats());
        ...
        ArrayList<Seat> seats_bus4 = new ArrayList<Seat>(bus4.getTotalSeats());
